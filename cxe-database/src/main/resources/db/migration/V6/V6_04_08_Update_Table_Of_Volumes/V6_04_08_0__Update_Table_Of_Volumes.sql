...
INSERT INTO `jb_volume`
(`bookDescription`,`bookGroup`,`bookLabel`,`bookNumber`,`generateLineItemTocByBA`,`generateLineItemTocByTitle`,`generateP1`,`generateProgramElementTocByBA`,`generateProgramElementTocByTitle`,`generateR1`,`generateR1Summary`,`generateR1c`,`generateR1d`,`overrideDocumentAssemblyOptionsInXml`,`serviceAgencyId`, `p40volume`, `agencyVolume`)
SELECT SERV_AGY_NAME, '1', 'Volume', '1', false, false, false, true, true, false, false, false, false, true, BUDGES_SERV_AGY_ID, true, true FROM SERVICE_AGENCY WHERE BUDGES_SERV_AGY_CODE = 'DMA';
...
INSERT INTO `jb_volume`
(`bookDescription`,`bookGroup`,`bookLabel`,`bookNumber`,`generateLineItemTocByBA`,`generateLineItemTocByTitle`,`generateP1`,`generateProgramElementTocByBA`,`generateProgramElementTocByTitle`,`generateR1`,`generateR1Summary`,`generateR1c`,`generateR1d`,`overrideDocumentAssemblyOptionsInXml`,`serviceAgencyId`, `p40volume`, `agencyVolume`)
SELECT SERV_AGY_NAME, '1', 'Volume', '1', false, false, false, true, true, false, false, false, false, true, BUDGES_SERV_AGY_ID, true, true FROM SERVICE_AGENCY WHERE BUDGES_SERV_AGY_CODE = 'DTRA';

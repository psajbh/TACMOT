...
public class R2AppnBudgetActivityEntity implements IEntity, Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		R2AppnBudgetActivityEntity other = (R2AppnBudgetActivityEntity) obj;
	...
	public String toString() {
		return "R2AppnBudgetActivityEntity [serviceAgencyId=" + serviceAgencyId + ", appropriationId=" + appropriationId
				+ ", budgetActivityId=" + budgetActivityId + ", budgetSubActivityId=" + budgetSubActivityId
				+ ", appnCode=" + appnCode + ", appnName=" + appnName + ", budgetActivityNum=" + budgetActivityNum
				+ ", budgetActivityTitle=" + budgetActivityTitle + ", budgetSubActivityNum=" + budgetSubActivityNum
				+ ", budgetSubActivityTitle=" + budgetSubActivityTitle + "]";
	}

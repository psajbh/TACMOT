...
////	public ResponseEntity<List<DownloadDto>> getDownloadsList(@RequestParam Boolean isRfr) {
...
////		bfuService.saveFiles(file, descriptions, username);
////	}
////	
...
////	}
////	
////	private ResponseEntity<List<DownloadDto>> processDownload(Boolean isRfr) {
////		List<DownloadDto> downloadDtos = bfuService.getAllFiles(isRfr);
////		

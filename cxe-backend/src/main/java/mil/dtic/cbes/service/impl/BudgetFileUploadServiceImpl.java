...
//	
//	private static final String systemFilePrefix = "SYS";
//	private static final String prcpFilePrefix = "PRCP";
//
//	/*
...
//	 */
//	@Override
//	public void saveFiles(List<MultipartFile> filesToUpload, List<String> descriptions, String username) throws IOException {
...
//			saveFile(fileToUpload, fileToUpload.getOriginalFilename(), username, fileDescription, systemFilePrefix);
//		}
//	}
//
//	/*
...
//			throws IOException {
//		
//		File uploadDirectory = new File(configService.getR2UploadFileStoragePath() + File.separator);
...
//		String fileType;
//		if (type.equals(systemFilePrefix)) {
//			newFileName.append(systemFilePrefix + "-");
//		} else if (type.equals(prcpFilePrefix)) {
//			newFileName.append(prcpFilePrefix + "-");
//		}

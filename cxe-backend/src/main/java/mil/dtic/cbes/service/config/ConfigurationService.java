...
public class ConfigurationService {
    ...
    private static final String LABEL_FOR_BES_JB = "xslt.jb.besLabel"; 
    private static final String LABEL_FOR_PB_JB = "xslt.jb.pbLabel"; 
    private static final String LABEL_FOR_BES = "xslt.besLabel"; 
    private static final String LABEL_FOR_PB = "xslt.pbLabel"; 
    private static final String LABEL_FOR_POM = "xslt.pomLabel"; 
    ...
    private static final String CLASSIFICATION_LABEL = "classification.label";
    private static final String CLASSIFICATION_SYMBOL = "classification.symbol"; 

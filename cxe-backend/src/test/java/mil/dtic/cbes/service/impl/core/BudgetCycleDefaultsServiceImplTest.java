...
import mil.dtic.cbes.service.impl.core.BudgetCycleDefaultsServiceImpl;

public class BudgetCycleDefaultsServiceImplTest {
	...
	public void testBudgetCyclesToXml() throws JAXBException, FileNotFoundException {
        ...
        marshaller.marshal(budgetCycles, ResourceUtils.getFile(BudgetCycleDefaultsServiceImpl.BUDGET_CYCLE));
	...
	public void testSubmissionDatesToXml() throws JAXBException, FileNotFoundException {
        ...
        Marshaller marshaller = jaxbContext.createMarshaller();
        marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, true);
        marshaller.marshal(submissionDates, ResourceUtils.getFile(BudgetCycleDefaultsServiceImpl.SUBMISSION_DATES));
	...
	public void testXmlToBudgetCycles() throws JAXBException, FileNotFoundException {
		...
		File file = ResourceUtils.getFile(BudgetCycleDefaultsServiceImpl.BUDGET_CYCLE);
        JAXBContext jaxbContext = JAXBContext.newInstance(BudgetCycles.class);
	...
	public void testXmlToSubmissionDates() throws JAXBException, FileNotFoundException {
		...
		File file = ResourceUtils.getFile(BudgetCycleDefaultsServiceImpl.SUBMISSION_DATES);
        JAXBContext jaxbContext = JAXBContext.newInstance(SubmissionDates.class);
        Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();

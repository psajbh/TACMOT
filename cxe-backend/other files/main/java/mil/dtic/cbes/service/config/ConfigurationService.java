...
public class ConfigurationService {
	...
	public String getSandboxPath() {
	  ...
	  public boolean getAttributesFromLdapForLocalUser() {
	      return Boolean.parseBoolean(findValueByName(ConfigurationService.USER_FROM_LDAP_FOR_LOCAL_USER));
	  }
	  
	  private String findValueByName(String name){
	      //log.trace("findValueByName: - start with name: " + name); too expensive
	      //readLock.lock();
	      try {
	          Config c = configMap.get(name);
	          return c == null ? null : c.getValue();
	      }
	      catch(Exception e) {
	          //log.error("ConfigService:findValueByName failure: " + e.getMessage(),e);
	          return null;
	      }
	      finally{
	          //readLock.unlock();
	    ...
	    private String findValueByName(String name, String defaultValue) {
	        String value = findValueByName(name);
	        return value == null ? defaultValue : value;
	    }

//	    public String getMaintenanceMessage(){
//	        return findValueByName(ConfigService.MAINTENANCE_MESSAGE);
//	    }

//	    private String formatCycle(String cycle, int year){
//	        return cycle + " " + year;
//	    }

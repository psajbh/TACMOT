...
public class P1Data {
	...
	public static final String BUDGET_SUBACTIVITY = "budgetSubActivity";
	public static final String P1_LINE_NUMBER = "lineNumber";
	public static final String LINE_ITEM_NUMBER = "liNumber";
	public static final String COST_TYPE = "costType";

	public static enum CostTypes {
		A, B, C;
		public static CostTypes getWeaponSystemCost() {
			return A;
		}

		public static CostTypes getLessPYAdvanceProcurement() {
			return B;
		}

		public static CostTypes getPlusCYAdvanceProcurement() {
			return C;
		}
	};

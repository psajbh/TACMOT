...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	@Transactional //wrapping this method a spring transactional will help prevent lazy intialization exceptions.
	private List<Recipe> getRecipes() {
		...
		Ingredient x = new Ingredient("ripe avocados", new BigDecimal(2), eachUom);
		guacRecipe.addIngredient(x);
		System.out.println();
